...
function CommentEditModal({commentEditModal,setCommentEditModal,userId,commentId}) {
  ...
  return (
    <Modal 
    opened={commentEditModal}
    centered={true}
    withCloseButton={false}
    onClose={() => setCommentEditModal(false)}
    >
    ...
    <div className='fieldsetStyleItems' style={{ textAlign: "center" }}>
                    ...
                    <input className="Input"
                        ...
                        name="report"
                    />
                    <button className="myButton" style={{ marginTop: "10px",marginLeft:"8px",cursor:"pointer" }} onClick={editSubmit}>
                        Submit
                    </button>
                </div>
